...
try
{
   ...
   ResultSet rs=stmt.executeQuery("select * from service_provider where studio_id='"+sr+"' ");
   if(rs.next())
   {
    %>
               ...
               <div class="col-md-6">
                  <div class="mapimg">
                    ...
                    <Br>
                     ...
                     <figure><img src="images/login.jpeg" style="height:500px;"  alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-6">
                  <form id="request" class="main_form" action="update_service_provider2.jsp" method="post">
                     <div class="row">
                        <div class="col-md-10 ">
