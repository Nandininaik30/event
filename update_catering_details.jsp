...
try
{
   ...
   ResultSet rs=stmt.executeQuery("select * from catering where catering_id='"+sr+"' ");
   if(rs.next())
   {
    %>
    <!DOCTYPE html>
            ...
            <div class="row ">
               ...
               <div class="col-md-6">
                  <div class="mapimg">
                    <br>
                    <br>    
                     <figure><img src="images/login.jpeg" style="height: 700px;"  alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-6">
                  <form id="request" class="main_form" action="update_catering_details2.jsp" method="post">
                     <div class="row">
                        <div class="col-md-10 ">
