                           ...
                           out.println("</td><td>");
                              ...
                              out.println("</td><td>");
                                 ...
                                 out.println("</td><td>");
                                    ...
                                    out.println("</td><td>");
                           %>
                           <a href="delete_employee_details.jsp?num=<%=rs.getString(1) %>" >Delete</a>
                           <%
                           out.println("</td><td>");
                               %> 
                               <a href="update_employee_details.jsp?num=<%=rs.getString(1) %>" >Update</a>
                               <%
                               out.println("</td></tr>");
                                   %>
                               <%
