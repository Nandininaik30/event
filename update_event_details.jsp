...
try
{
   ...
   ResultSet rs=stmt.executeQuery("select * from event where event_id='"+sr+"' ");
   if(rs.next())
   {
    %>
      ...
      <div class="contact">
         <div class="container-fluid">
            <div class="row ">
               ...
               <div class="col-md-6">
                  <form id="request" class="main_form" action="update_event_details2.jsp" method="post">
                     <div class="row">
                        <div class="col-md-10 ">
                        ...
                        <div class="col-md-10">
                           <label> name</label>
                           <input class="contactus" placeholder="" type="text" name="t2" value="<%=rs.getString(2)%>"> 
                        </div>
                        <div class="col-md-10">
                            <label>type</label>
                         ...
                         <div class="col-md-10">
                            <label>catering_id</label>
                            <input class="contactus" placeholder="" type="text" name="t13" value="<%=rs.getString(13)%>"> 
                         </div>
                         <div class="col-md-10">
                            <label>media_id</label>
                            <input class="contactus" placeholder="" type="text" name="t14" value="<%=rs.getString(14)%>"> 
                         </div>
                         <div class="col-md-10">
                            <label>approved</label>
                            <input class="contactus" placeholder="" type="text" name="t15" value="<%=rs.getString(15)%>"> 
                         </div>
                       <br>
                       <br>
