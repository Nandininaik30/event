...
try
{
   ...
   ResultSet rs=stmt.executeQuery("select * from media_requirements where media_id='"+sr+"' ");
   if(rs.next())
   {
    %>
      ...
      <div class="contact">
         <div class="container-fluid">
            <div class="row ">
               ...
               <div class="col-md-6">
                  <form id="request" class="main_form" action="update_media_requirement2.jsp" method="post">
                     <div class="row">
                        <div class="col-md-10 ">
                        ...
                        <div class="col-md-10">
                         ...
                         <div class="col-md-10">
                            <label> 
                              drone</label>
                            <input class="contactus" placeholder="" type="text" name="t5" name="<%=rs.getString(5) %>"> 
                         </div>
                         <div class="col-md-10">
                           <label> 
                             drone</label>
                           <input class="contactus" placeholder="" type="text" name="t6" name="<%=rs.getString(6) %>"> 
                        </div>
                          <br><BR>
                        <div class="col-md-12">
                            <br>
