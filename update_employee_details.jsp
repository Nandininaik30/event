...
try
{
   ...
   ResultSet rs=stmt.executeQuery("select * from employee where emp_id='"+sr+"' ");
   if(rs.next())
   {
    %>
    <!DOCTYPE html>
            ...
            <div class="row ">
               ...
               <div class="col-md-6">
                  <div class="mapimg">
                    ...
                    <Br>
                        <Br>   
                     <figure><img src="images/login.jpeg" style="height:900px;"  alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-6">
                  <form id="request" class="main_form" action="update_employee_Details2.jsp" metho="post">
                     <div class="row">
                        <div class="col-md-10 ">
                           <label>emp_id</label>
